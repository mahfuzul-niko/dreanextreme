...
class SliderController extends Controller
{
    ...
    public function home_page_four_banner_update(Request $request)
    {
        ...
        if ($request->image){
            ...
            $img = 'mid_banner_'.time().'.'.$image->getClientOriginalExtension();
        ...
        $banner->save();
        return redirect()->route('f.banner.show')->with('success', 'Banner has been changed');
    ...
    public function store(Request $request)
    {
        ...
        ->with('success', 'New Slider Added Successfully');
    ...
    public function destroy(Request $request)
    {
        ...
        $slider->delete();
        return redirect()->route('slider.index')->with('success', 'Slide has been deleted');
    }
}
