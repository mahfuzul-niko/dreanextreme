...
//service store
Route::post('/service', [App\Http\Controllers\PageController::class, 'serviceStore'])->name('service.store');

//service
Route::get('/flagship-service', [App\Http\Controllers\PageController::class, 'serviceRepeir'])->name('service.flagship');
...
Route::group(['prefix' => '/home', 'middleware' => ['auth', 'verified', 'adminAuth']], function () {
	...
	Route::group(['prefix' => 'product', 'as' => 'product.'], function () {
		...
		//status
		Route::post('/product/update-status', [App\Http\Controllers\ProductController::class, 'updateStatus'])->name('update.status');

		//bulk
		Route::post('/product/bulk-action', [App\Http\Controllers\ProductController::class, 'bulkAction'])->name('bulk.action');
	...
	//service route
	Route::get('/service-list', [App\Http\Controllers\OrderController::class, 'serviceList'])->name('service.list');

	Route::post('/service-destroy/{id}', [App\Http\Controllers\OrderController::class, 'serviceDelete'])->name('service.destroy');

	Route::get('/service-edit/{id}', [App\Http\Controllers\OrderController::class, 'serviceEdit'])->name('service.edit');
