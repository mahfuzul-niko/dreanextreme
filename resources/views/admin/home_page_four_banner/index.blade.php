                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="position" class="form-control @error('position') is-invalid @enderror" required>
                          ...
                          <option value="1">1st Banner [ Image Size: 1071 X 495 px ]</option>
                          <option value="2">2nd Banner [ Image Size: 1071 X 495 px ]</option>
                          <option value="3">Full Banner [ Image Size: 100vw X 500 px ]</option>
                        </select>
                        @error('position')
