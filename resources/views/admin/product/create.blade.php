						...
						<div class="col-md-8">
							<div class="row">
								...
								<div class="form-group col-md-4">
									...
									<div class="">
									<input type="text" name="unit_type" required placeholder="Piece" value="{{ old('unit_type','Piece') }}" class="form-control @error('unit_type') is-invalid @enderror">
										@error('unit_type')
											<span class="invalid-feedback" role="alert">
												<strong>{{ $message }}</strong>
											</span>
								...
								<div class="form-group col-md-4">
									<label class="col-form-label"><b>Thumbnail ( 600px X 600px ) *</b></label>
									<div class="">
		...
		<div class="modal-body">
			<div class="row">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="size" value="" placeholder="64GB, 128GB, 265GB">
				</div>
