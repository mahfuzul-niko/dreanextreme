        ...
        <div class="container-fluid">
            <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label class="col-form-label"><b>Thumbnail *</b></label>
                                                <div>
                                                    ...
                                                    <div class="mt-2">
                                                        <img id="previewImage" src="#" alt="Preview"
                                                            ...
                                                            class="border rounded shadow-sm p-1">
                                                    </div>
                                                </div>
                                            </div>
				...
				--}}
                                            ...
                                            <div class="form-group">
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio" name="type"
                                                        id="for_single" value="single" required="">
                            ...
                            <div class="col-md-12 my-3">
                                <div id="single" class="shadow rounded p-2 border row" style="display:none;">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" step="any" name="qty" value="{{ old('qty') }}"
							...
							<table class="table table-bordered " style="border-collapse: collapse; display:block; width: 100%;">
								<tbody>
								<tr>
								...
								<tr>
								<td style="width: 50%;">RAM & Storage</td>
								<td style="width: 50%;">&nbsp;</td>
								</tr>
								<tr>
