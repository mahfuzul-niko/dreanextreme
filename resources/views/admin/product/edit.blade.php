                ...
                <div class="card-header">
                    <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-8">
                                        <div class="row">
                                                ...
                                                <div class="">
                                                    <select name="brand_id"
                                                        ...
                                                        @foreach ($brands as $brand)
                                                            <option
                                                                @if ($brand->id == $product->brand_id) selected class="text-light bg-success" @endif
                                                                value="{{ $brand->id }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="">
                                                    <input type="text" name="unit_type" required placeholder="Piece"
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label"><b>Thumbnail ( 600px X 600px )
                                                            *</b></label>
                                                    <div class="col-sm-10">
                                                        ...
                                                        <img src="{{ asset('images/product/' . $product->thumbnail_image) }}"
                                                            class="shadow rounded mt-2 p-1" width="150px">
                                                    </div>
                                                </div>
                                            ...
                                            <div id="">
                                                <select class="form-control select2" name="categories[]" multiple="multiple"
                                                    ...
                                                    @foreach ($categories as $category)
                                                        @php
                                                            $check_category = DB::table('product_with_categories')
                                                                ->where([
						...
						<div class="">
                                        ...
                                        <div class="">
                                            <div class="form-group">
                                                ...
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio" name="type"
                                                        {{ $product->type == 'variation' ? 'checked' : '' }}
                                                        id="for_variation" value="variation">
                                                ...
                                                <div id="variations_div" class=" p-2">
                                                    @if (count($product->variation_stock) > 0)
                                                        @foreach ($product->variation_stock as $variation)
                                                            <div class="row p-2 shadow rounded mb-4"
                                                                id="variation_info_div_{{ $variation->id }}">
                                                                <input type="hidden"
                                                                    id="variation_parent{{ $variation->id }}"
                                                                    name="variation_parent[]"
                                                                    value="{{ $variation->id }}">
                                                                <input type="hidden" name="colour_attribute[]"
                                                                    value="{{ $variation->color }}">
                                                                <input type="hidden" name="new_or_old[]" value="old">
                                                                <div class="col-md-6">
                                                                    <div>
                                                                        @if (!empty($variation->color))
                                                                            <div class="p-2 shadow rounded"><b>Colour: </b>
                                                                                <span
                                                                                    style="background-color: {{ optional($variation->color_info)->code }}; padding: 5px;">{{ optional($variation->color_info)->name }}</span>
                                                                            </div><br>
                                                                        @endif
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <input type="hidden"
                                                                                name="attribute_id{{ $variation->id }}"
                                                                                value="{{ $variation->variant }}">
                                                                            @if ($variation->variant != '')
                                                                                <label><span
                                                                                        class="text-danger">*</span>{{ optional($variation->attribute_info)->title }}</label>
                                                                                <input type="text" class="form-control"
                                                                                    name="attribute_value[]"
                                                                                    value="{{ $variation->variant_output }}"
                                                                                    required="">
                                                                            @else
                                                                                <input type="hidden"
                                                                                    name="attribute_value[]">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-form-label"><span
                                                                                class="text-danger">*</span><b>CODE</b></label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="is_active[]" class="form-control"
                                                                            id="">
                                                                            <option
                                                                                @if ($variation->is_active == 1) class="text-light bg-success" selected @endif
                                                                                value="1">Active</option>
                                                                            <option
                                                                                @if ($variation->is_active == 0) class="text-light bg-success" selected @endif
                                                                ...
                                                                <div class="col-md-6 shadow rounded border p-1 px-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="file"
                                                                            name="variation_image{{ $variation->id }}"
                                                                            class="form-control">
                                                                        <img src="{{ asset('images/product/' . $variation->image) }}"
                                                                            class="shadow rounded mt-2 p-1" width="150px"
                                                                            style="margin-right: 15px;">
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-form-label"><span
                                                                                class="text-danger">*</span><b>Variant
                                                                                Price</b></label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-form-label"><span
                                                                                class="text-danger">*</span><b>Stock
                                                                                Quantity</b></label>
                                                                        <input type="number" name="variation_stock_qty[]"
                                                                            value="{{ $variation->qty }}"
                                                                            class="form-control">
                                                                    </div>
                            ...
                            <div class="col-md-12 my-3">
                                <div id="single" class="shadow rounded p-2 border row"
                                    style="{{ $product->type == 'single' ? '' : 'display: none;' }}">
                                    <div class="form-group col-md-6">
                                        <label class=""><b>Price *</b></label>

                                        <input type="number" step="any" name="single_price"
                                            value="{{ optional($product->single_stock)->price }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" step="any" name="single_qty"
                                            value="{{ optional($product->single_stock)->qty }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="is_featured" class="mr-3">
                                            <input type="checkbox" name="is_featured" value="1"
                                                {{ $product->is_featured == 1 ? 'checked' : '' }} id="is_featured">
                                            Featured Products
                                        </label>

                                        <label for="is_tranding" class="mr-3">
                                            <input type="checkbox" name="is_tranding" value="1"
                                                {{ $product->is_tranding == 1 ? 'checked' : '' }} id="is_tranding">
                                            Tranding Product
                                        </label>

                                        <label for="todays_deal" class="mr-3">
                                            <input type="checkbox" name="todays_deal" value="1"
                                                {{ $product->todays_deal == 1 ? 'checked' : '' }} id="todays_deal">
                                            Today's Deal
                                        </label>
                                ...
                                <div class="shadow row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="discount_type" class="form-control" id="">
                                            <option
                                                @if ($product->discount_type == 'no') selected class="text-light bg-success" @endif
                                                value="no">NO</option>
                                            <option
                                                @if ($product->discount_type == 'flat') selected class="text-light bg-success" @endif
                ...
                <form action="" method="POST" id="variation_form">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="exampleFormControlSelect1">Variant Colors</label>
                                    <select class="form-control" name="colour" id="">
                                        <option value="">Select</option>
                                        @foreach ($colors as $key => $color)
                                            <option style="background-color: {{ $color->code }};"
                                                value="{{ $color->code }}">{{ $color->name }} </option>
                                        @endforeach
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label for="exampleFormControlSelect1">Variant Value</label>
                                    <input type="text" class="form-control" name="size" value=""
                                        placeholder="64GB, 128GB, 265GB">
                                </div>

                                <div class="form-group">
                                    <label for="exampleFormControlSelect1">Variant CODE</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class=""><b>Variation Name</b></label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="add_variation_button" class="btn btn-primary">Generate
                            Variation</button>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        function add_more_customer_choice_option(i, name) {
            $('#customer_choice_options').append(
                '<div class="form-group col-md-6"><div class="col-md-3"><input type="hidden" name="choice_no[]" value="' +
                ...
                i + '[]" placeholder="Enter choice values"></div></div>');
        }
