...
<head>
  ...
  <!-- End style -->
    {!! optional($business)->head !!}
</head>

<body>
    {!! optional($business)->body !!}
  ...
  <script>
    ...
    function addToCart(product_id, selected_variation_id2, type, page, product_type2) {
      console.log('product_id:',product_id,'selected_variation_id2:',selected_variation_id2,'type:',type,'page:',page,'product_type2:',product_type2);
      url = "{{ route('cart.add') }}";
