                    ...
                    <div class="account__wrapper account__wrapper--style4 border-radius-10">
                        <div class="account__content">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <button class="btn btn-outline-primary btn-lg btn-icon-text" id="printButton" style="display:block;" onclick="printSpecialArea()">
                                        ...
                                        <div class="cart__summary--total mb-20">
                                            <table class="cart__summary--total__table">
                                                <tbody>
                                                    ...
                                                    @endif
                                                    <tr class="cart__summary--total__list">
                                                        <td class="cart__summary--total__title text-left">Shipping Charge 
