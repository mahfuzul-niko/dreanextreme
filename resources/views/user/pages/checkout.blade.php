            ...
            <div class="row mb-9">
                                            ...
                                            <td class="cart__table--body__list">
                                                <div class="product__image two d-flex align-items-left">
                                                    <div class=" border-radius-5">
                                                        <a href="{{route('single.product', [$product_info->id, Str::slug($product_info->title)])}}"><img class="border-radius-5 shadow rounded p-1"
                                                            style="
                                                                min-width:100px;
                                                                max-width:100px
                                                                " src="{{asset('images/product/' .optional($product_info)->thumbnail_image)}}" alt="cart-product"></a>
                                                        <span class="product__thumbnail--quantity">{{$cart->qty}}</span>
                                                    </div>
                                                    <div class="product__description">
                                                        <h3 style="line-height: 24px !important;" class="product__description--name h4">
                                                            <a class="text-dark" href="{{route('single.product', [$product_info->id, Str::slug($product_info->title)])}}">{{$product_info->title}}</a></h3>
                ...
                <div class="col-lg-7 pr-lg-4 mb-4 p-3">
                    ...
                    <div class="row gutter-sm">
                        <div class="col-xs-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="checkout__input--field border-radius-5" name="name" value="{{ Auth::user()?optional(Auth::user())->name . ' ' . optional(Auth::user())->last_name :'' }}"  placeholder="আপনার সম্পূর্ণ নাম" required>
                            </div>
                        </div>
                            ...
                            <tr>
                                ...
                                <td width="50%" class="form-group mb-3">
                                    <div class="checkout__checkbox">
                                        <input class="checkout__checkbox--input shipping_method" id="check{{$district->id}}" type="radio" name="district_id" value="{{ $district->id }}" required>
                                        <span class="checkout__checkbox--checkmark"></span>
                                        <label class="checkout__checkbox--label" for="check{{$district->id}}">
                                            {{ $district->name }}:
                                            <strong>{{ $district->shipping_charge }} <span> TK</span></strong></label>
                                    </div>
                                </td>
                            </tr>
                                @endforeach
                    ...
                    <div class="checkout__content--step__footer d-flex align-items-center">
                        <button class="continue__shipping--btn primary__btn border-radius-5" type="submit">Confirm Order</button>
