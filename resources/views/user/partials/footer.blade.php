...
style="background-color: <?php echo $business->footer_bg_color; ?> !important;">
    <div class="container-fluid">
        
        <div class="main__footer d-flex justify-content-between row" style="padding-bottom: 5px !important;">

            <div class="footer__widget footer__widget--width col active">
                ...
                <div class="footer__widget--inner" style="display: block;">
                    <div class="flex flex-col gap-4" style="align-items:flex-start;">
                        @for ($n=1; $n<=2; $n++)
                            <div class="duration-300 px-6 py-3 rounded-full border-white border-primary-hover flex items-center gap-4" style="
                                ...
                                <span class="" style="margin-left:30px;">
                                    ...
                                    @elseif($n==2)
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-map-pin text-white text-2xl"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                                    @endif
                                </span>
                                ...
                                <div class="flex flex-col w-full">
                                    @if ($n==1)
                                    <a class="text-3xl tracking-wider text-white border-primary-hover" href="tel:{{optional($business)->phone}}">{{optional($business)->phone}}</a>
                                    @elseif($n==2)
                                    <a class="text-3xl tracking-wider text-white border-primary-hover" href="{{ $business->google_map_link }}" target="_blank">Find Our Store</a>
                                    @endif
                                </div>
                        ...
                        <div class="footer__social" style="margin-left:80px; margin-top:20px;">
                            <ul class="social__shear d-flex">
                                <li class="social__shear--list">
                                    <a class="social__shear--list__icon" target="_blank" href="{{optional($business)->facebook}}">
                                        <svg  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 7.667 16.524">
                                            <path  data-name="Path 237" d="M967.495,353.678h-2.3v8.253h-3.437v-8.253H960.13V350.77h1.624v-1.888a4.087,4.087,0,0,1,.264-1.492,2.9,2.9,0,0,1,1.039-1.379,3.626,3.626,0,0,1,2.153-.6l2.549.019v2.833h-1.851a.732.732,0,0,0-.472.151.8.8,0,0,0-.246.642v1.719H967.8Z" transform="translate(-960.13 -345.407)" fill="#4867AA"/>
                                        </svg>
                                ...
                                <li class="social__shear--list">
                                    <a class="social__shear--list__icon" target="_blank" href="{{optional($business)->twitter}}">
                                        <svg  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 16.489 13.384">
                                            <path  data-name="Path 303" d="M966.025,1144.2v.433a9.783,9.783,0,0,1-.621,3.388,10.1,10.1,0,0,1-1.845,3.087,9.153,9.153,0,0,1-3.012,2.259,9.825,9.825,0,0,1-4.122.866,9.632,9.632,0,0,1-2.748-.4,9.346,9.346,0,0,1-2.447-1.11q.4.038.809.038a6.723,6.723,0,0,0,2.24-.376,7.022,7.022,0,0,0,1.958-1.054,3.379,3.379,0,0,1-1.958-.687,3.259,3.259,0,0,1-1.186-1.666,3.364,3.364,0,0,0,.621.056,3.488,3.488,0,0,0,.885-.113,3.267,3.267,0,0,1-1.374-.631,3.356,3.356,0,0,1-.969-1.186,3.524,3.524,0,0,1-.367-1.5v-.057a3.172,3.172,0,0,0,1.544.433,3.407,3.407,0,0,1-1.1-1.214,3.308,3.308,0,0,1-.4-1.609,3.362,3.362,0,0,1,.452-1.694,9.652,9.652,0,0,0,6.964,3.538,3.911,3.911,0,0,1-.075-.772,3.293,3.293,0,0,1,.452-1.694,3.409,3.409,0,0,1,1.233-1.233,3.257,3.257,0,0,1,1.685-.461,3.351,3.351,0,0,1,2.466,1.073,6.572,6.572,0,0,0,2.146-.828,3.272,3.272,0,0,1-.574,1.083,3.477,3.477,0,0,1-.913.8,6.869,6.869,0,0,0,1.958-.546A7.074,7.074,0,0,1,966.025,1144.2Z" transform="translate(-951.23 -1140.849)" fill="#1C9BE9"/>
                                        </svg>
            ...
            <div class="footer__widget--menu__wrapper col d-flex footer__widget--width active">
                <div class="footer__widget">
                    ...
                    <ul class="footer__widget--menu footer__widget--inner" style="display: block;">
                        ...
                        @endphp
                        @if($blogs)
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="{{route('user.blog')}}">Blogs</a></li>
                        @endif
            ...
            <div class="footer__widget--menu__wrapper col d-flex footer__widget--width active">
                <div class="footer__widget">
                    ...
                    <ul class="footer__widget--menu footer__widget--inner" style="display: block;">
                        {{-- <li class="footer__widget--menu__list mb-5"><a class="footer__widget--menu__text" target="_blank">{{ config('app.name') }}</a></li> --}}

                        <li class="footer__widget--menu__list"><a class="footer-address-text" href="{{ $business->google_map_link }}" target="_blank">{{optional($business)->address}}</a></li> 
                        ...
                        <li class="footer__widget--menu__list">
                            ...
                            <a class="footer__widget--menu__text" href="mailto:{{optional($business)->email}}" style="">{{optional($business)->email}}</a></li>                        
                    </ul>
                </div>
            </div>  
        ...
        <div class="py-2 row">
            <div class="col-md-4 offset-md-4">
                {{-- <p class="copyright__content text-ofwhite m-0">
                    <a class="copyright__content--link text-white"> 
                        Prices are subject to change without any prior notice.
                    </a>
                </p>  --}}
                <p class="copyright__content text-ofwhite m-0">
                    <a class="copyright__content--link text-white" style="text-decoration:none;" href="https://faraitltd.com/" target="_blank"> &copy; 2024 Thanks From {{ config('app.name') }} | All rights reserved
                    </a>
                </p> 
            </div>
...
@include('user.inc.phone')
<!-- End News letter popup -->
@include('user.inc.whatsapp')
